...
import com.book.borrow.carousel.service.ICarouselService;
 ...
 */
@RestController
@RequestMapping("/bookinfo/carousel")
public class CarouselController extends BaseController
{
     ...
     * 获取轮播图详细信息
     */
    @PreAuthorize("@ss.hasPermi('bookinfo:carousel:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增轮播图
     */
    @PreAuthorize("@ss.hasPermi('bookinfo:carousel:add')")
     ...
     * 修改轮播图
     */
    @PreAuthorize("@ss.hasPermi('bookinfo:carousel:edit')")
     ...
     * 删除轮播图
     */
    @PreAuthorize("@ss.hasPermi('bookinfo:carousel:remove')")
